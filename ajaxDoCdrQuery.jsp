...
String imsiQueryApiUri = gcSystemUri + "API_CdrQuery.jsp";
...
writeLog("debug", "My IMSI/ICCID CDR query API URL= " + imsiQueryApiUri);
...
try
{
	...
	writeLog("debug", "My IMSI CDR query server response: " + sResponse);
}catch (Exception e){
	...
	writeLog("error", "Exception when send message to my IMSI CDR query server: " + e.toString());
}
