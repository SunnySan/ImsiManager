...
;
/*
 * jQuery UI Combobox 1.8.2
 */
(function( $ ) {
    $.widget( "ui.addresscombobox", {
    	options: {
    		id: "",
    		name: "",
    		width: "5.5em",
        ...
        _create: function() {
            ...
            input = $( "<input>" )
                ...
                .attr( "title", "" )
                .addClass( that.options.cssclass )
                .addClass( "ui-state-default ui-combobox-input" )
                .width(that.options.width)
                .addClass( "ui-widget ui-widget-content ui-corner-left" );
            if (that.options.required)
            	input = input.attr("validate", "{required:true, messages:{required:\"" + that.options.messages +"\"}}");
